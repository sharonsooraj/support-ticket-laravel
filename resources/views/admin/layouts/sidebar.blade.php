<div class="deznav">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a class="{{ request()->routeIs('admin.dashboard') ? 'active bg-light has-arrow' : '' }}"
            ...
            <li class="{{ request()->routeIs('admin.tickets') ? 'active bg-light has-arrow' : '' }}"><a href="{{ route('admin.tickets') }}"
